    ...
    <div className="bg-gray-100 w-full"> 
      <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
          ...
          <div className="md:max-w-md lg:col-span-2">
            ...
            <form className="flex flex-col mt-4 md:flex-row">
              <input
                ...
                type="email"
                className="flex-grow w-full h-12 px-4 mb-3 transition duration-200 bg-white border border-gray-300 rounded-lg shadow-sm appearance-none md:mr-2 md:mb-0 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-200"
              />
              <button
                type="submit"
        ...
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-300 sm:flex-row">
          <p className="text-sm text-gray-600">© Copyright 2024 CheCasa Inc. Todos los derechos reservados.</p>
