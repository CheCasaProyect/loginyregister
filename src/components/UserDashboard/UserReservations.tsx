...
const MyReservations: React.FC = () => {
  const reservations: IReserva[] = [
    { 
      id: '1', 
      property: 'Apartamento en la playa', 
      checkIn: '2024-12-01', 
      checkOut: '2024-12-20', 
      location: 'Mar del Plata', 
      guests: 3, 
      state: 'Activa', 
      imageUrl: "https://a0.muscache.com/im/pictures/miso/Hosting-43403945/original/02fd85af-475d-44d8-a585-c1cc9b02df7a.jpeg?im_w=1200" 
    },
    { 
      id: '2', 
      ...
      guests: 2, 
      state: 'Cancelada', 
      imageUrl: "https://a0.muscache.com/im/pictures/miso/Hosting-771088465922817191/original/6df092b3-e3d2-40fa-b623-dc70d1ddcdf4.jpeg?im_w=1200" 
    }
  ];
